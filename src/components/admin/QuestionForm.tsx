                ...
                >
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="md:col-span-2">
                            ...
                            <Textarea
                                rows={5}
                                {...register("text", {required: "Texte requis"})}
                            />
                            {errors.text && (
                        ...
                        <div>
                            ...
                            <Select
                                ...
                                defaultValue={
                                    mode === "edit" && question ? question.type : "multiple-choice"
                                }
                            >
                        ...
                        <div>
                            ...
                            <Select
                                onValueChange={(v: Difficulty) => setValue("difficulty", v)}
                        ...
                        {type === "multiple-choice" && (
                            <div className="md:col-span-2 space-y-2">
                                ...
                                <div>
                                    ...
                                    <Select
                                        onValueChange={(v: string) => setValue("correctAnswer", v)}
                        ...
                        {type === "short-answer" && (
                            <div>
                                <Label>Réponse correcte</Label>
                                <Input
                                    {...register("correctAnswer", {required: "Réponse requise"})}
                                />
