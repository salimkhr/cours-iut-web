...
export default function EmailVerifiePage() {
    return (
        <main className="flex flex-col items-center justify-center min-h-screen bg-brand-light dark:bg-brand-dark px-4">
            <div className="flex flex-col items-center gap-6 max-w-sm text-center">
                ...
                <Button asChild className="bg-brand-accent-dark hover:bg-brand-accent-dark/90 text-white">
