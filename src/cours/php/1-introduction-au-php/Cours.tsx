...
#titre { font-weight: bold; }`}
            ...
            <section>
                <Text>
                    ...
                    Vous découvrirez le fonctionnement du protocole HTTP, les bases du langage PHP
                    et les principes de la programmation orientée objet.
                </Text>
                <List>
                    <ListItem><strong>Objectif 1</strong> : comprendre le protocole HTTP et la communication client-serveur.</ListItem>
                    <ListItem><strong>Objectif 2</strong> : maîtriser la syntaxe de base de PHP (variables, structures de contrôle, boucles).</ListItem>
                    <ListItem><strong>Objectif 3</strong> : découvrir la programmation orientée objet en PHP (classes, héritage, traits).</ListItem>
                </List>
            </section>
            ...
            <section>
                ...
                <Heading level={4}>2.1 Qu&apos;est-ce qu&apos;une URL ?</Heading>
                <Text>
                ...
                <List ordered>
                    ...
                    <ListItem><strong>Le numéro de port :</strong> un numéro associé à un service, permettant
                        au serveur d&apos;identifier le type de ressource demandée. Le port utilisé par HTTP est le 80,
                ...
                <Heading level={4}>2.2 Requête HTTP</Heading>
                <Text>
                    Une requête HTTP commence par une méthode qui indique l&apos;action que le navigateur souhaite
                    effectuer. Les méthodes les plus courantes sont :
                </Text>
                <List>
            ...
            <section>
                ...
                <Text>
                    PHP est un langage de script associé à HTML. Son but est de générer du contenu HTML à partir de
                    données.
                </Text>
...
$isStudent = true;          // Booléen`}
                ...
                <Text>
                    ...
                    type est déterminé automatiquement, même s&apos;il peut être contraint. Ici, <Code>$message</Code> est
                    une chaîne de caractères, <Code>$age</Code> est un entier, <Code>$price</Code> est un flottant
...
echo "Hello, World!";`}
                ...
                <Heading level={4}>3.1 Les conditions</Heading>

                <Text><strong>Conditions avec <Code>if</Code> :</strong></Text>
                <CodeCard language="php">
                    {`<?php
$humeur = 'triste';
if ($humeur === 'heureux') {
    ...
    echo $humeur;
                ...
                <List>
                    ...
                    <ListItem>
                        ...
                        signifie que <Code>&apos;5&apos;</Code> (chaîne de caractères) et <Code>5</Code> (entier) ne
                        seront pas considérés comme égaux avec <Code>===</Code>, car leurs types sont différents.
                    </ListItem>
                </List>
...
if (5 === '5') {
    ...
    echo "5 === '5' : faux";
                ...
                <Text>
                    ...
                    vrai</Code>, car PHP convertit la chaîne en entier et les valeurs sont égales. Par contre, la
                    seconde condition avec <Code>===</Code> renverra <Code>5 === &apos;5&apos; : faux</Code>, car bien
                    que les valeurs soient identiques, leurs types diffèrent (entier vs chaîne de caractères).
                </Text>

                <Text><strong>Conditions avec l&apos;opérateur ternaire :</strong></Text>
                <CodeCard language="php">
                    {`<?php
echo $humeur !== 'heureux' ? 'Je suis de bonne humeur' : 'bof!!';`}
                </CodeCard>

                <Text><strong>Conditions avec <Code>switch</Code> :</strong></Text>
                <CodeCard language="php">
                    {`<?php
$humeur = 'triste';
switch ($humeur) {
    ...
    default:
        echo $humeur;
                ...
                <Text><strong>Conditions avec <Code>match</Code> :</strong></Text>
                <CodeCard language="php">
                    {`<?php
$humeur = 'triste';
echo match ($humeur) {
    ...
    default => $humeur,
                ...
                <Heading level={4}>3.2 Les boucles</Heading>

                <Text><strong>La boucle <Code>while</Code> :</strong></Text>
                <CodeCard language="php">
                    {`<?php
$compteur = 1;
while ($compteur < 12) {
    ...
    $compteur++;
                ...
                <Text><strong>La boucle <Code>do ... while</Code> :</strong></Text>
                <CodeCard language="php">
                    {`<?php
$num = 1;
do {
    ...
    $num++;
                ...
                <Text><strong>La boucle <Code>for</Code> :</strong></Text>
                <CodeCard language="php">
                    {`<?php
for ($compteur = 1; $compteur < 12; $compteur++) {
    echo "compteur: $compteur <br>\\n";
                ...
                <Text><strong>La boucle <Code>foreach</Code> :</strong></Text>
                <CodeCard language="php">
                    {`<?php
...
foreach ($fruits as $fruit => $couleur) {
    echo 'Le fruit ' . $fruit . ' est de couleur ' . $couleur . '<br>';
            ...
            <section>
                <Heading level={2}>C- Programmation orientée objet</Heading>

                <Heading level={3}>1. Définition d&apos;une classe</Heading>
                <Text>
                    En PHP, la structure d&apos;une classe est similaire à celle de Java. Les méthodes magiques sont
                    des méthodes spéciales qui commencent par deux underscores (__) et ont des comportements
    ...
    public function setAge(int $age): void
    {
        $this->age = $age;
                ...
                <Text>
                    ...
                    définir comment l&apos;objet sera converti en chaîne de caractères lorsqu&apos;il est utilisé dans
...
class Person
{
    ...
    public function getAge(): int
    {
        return $this->age;
                ...
                <Heading level={3}>2. Instanciation d&apos;un objet</Heading>
                <Text>
                    Pour créer un objet à partir d&apos;une classe, vous utilisez le mot-clé <Code>new</Code> :
                </Text>
                <CodeCard language="php">
                    {`<?php
$person1 = new Person('Alice', 30);
echo $person1; // Affiche "Name: Alice, Age: 30"`}
                </CodeCard>
                <Text>
                    Ici, l&apos;objet <Code>$person1</Code> est créé avec les
                    valeurs &quot;Alice&quot; pour <Code>$name</Code> et 30 pour <Code>$age</Code>. Lorsque
                    l&apos;objet est converti en chaîne, la méthode <Code>__toString</Code> est appelée
                    automatiquement.
                </Text>

                <Heading level={3}>3. Héritage</Heading>
                <Text>
                    PHP permet l&apos;héritage avec des classes, ce qui signifie qu&apos;une classe peut en étendre
                    une autre. De plus, il est possible d&apos;utiliser des méthodes magiques dans les classes
                    dérivées.
                </Text>
                <CodeCard language="php">
                    {`<?php
    ...
    public function __toString(): string
    {
        return parent::__toString() . ', Position: ' . $this->position;
                ...
                <Text>
                    ...
                    l&apos;héritage. Ils sont particulièrement utiles pour partager des méthodes communes entre
                    des classes qui n&apos;ont pas de relation hiérarchique.
                </Text>
                <CodeCard language="php">
                    {`<?php
trait Logger
...
class Employee extends Person
{
    ...
    public function work(): void
    {
        $this->log($this->name . ' is working.');
                ...
                <Text>
                    L&apos;héritage en PHP est utilisé pour établir une relation hiérarchique entre les classes, où une
                    classe enfant hérite des propriétés et des méthodes d&apos;une classe parent. En revanche, les
                    ...
                    avoir besoin d&apos;utiliser l&apos;héritage.
                </Text>
            </section>
        </article>
    );
