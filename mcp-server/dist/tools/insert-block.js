...
export function registerInsertBlock(server) {
    server.tool("insert_block", "Insère un nouveau bloc dans l'arbre de contenu. parentBlockId null = racine. afterBlockId null = fin.", {
        moduleSlug: z.string(),
        ...
        const newBlock = createBlock(blockType, props ?? {}, CONTAINER_TYPES.has(blockType) ? [] : undefined);
